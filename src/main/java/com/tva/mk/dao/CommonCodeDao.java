...
//	@Query(nativeQuery= true, value = "SELECT * FROM common_code a, common_type b WHERE a.id_type ="
//			+ " :id_type AND b.id = a.id_type")
//	public List<CommonCode> ViewCommonCodeByIdType(@Param("id_type") int idType);
//
//	@Query(nativeQuery= true, value="SELECT * FROM common_code a, common_type b WHERE"
